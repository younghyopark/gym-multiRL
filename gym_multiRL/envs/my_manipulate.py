...
from gym_multiRL.envs import rotations
...
#     print(goal_a.shape)
    ...
    # print(delta_pos)
    if index==0:
        lmbda = np.array([1e6,1,1])
    elif index==1:
        lmbda = np.array([1,1e6,1])
    elif index==2:
        lmbda = np.array([1,1,1e6])
...
#     print(goal_a.shape)
    ...
    # print(delta_pos)
    if index==0:
        lmbda = np.array([1e6,1,1,1])
    elif index==1:
        lmbda = np.array([1,1e6,1,1])
    elif index==2:
        lmbda = np.array([1,1,1e6,1])
    elif index==3:
        lmbda = np.array([1,1,1,1e6])
